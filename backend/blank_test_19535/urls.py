"""blank_test_19535 URL Configuration
...
admin.site.site_header = "blank test"
admin.site.site_title = "blank test Admin Portal"
admin.site.index_title = "blank test Admin"

# swagger
api_info = openapi.Info(
    title="blank test API",
    default_version="v1",
    description="API documentation for blank test App",
)
